...
$application.controller('appDashboardCtrl', ['$scope', function ($scope) {
...
.controller('markCtrl', ['$scope', function ($scope) {
    $scope.more = false;

    $scope.ssids = ['Nebula_Portland_1G', 'Nebula_Portland_3G', 'Nebula_Portland_4G', 'Nebula_Portland_5G', 'Nebula_Portland_7G'];
}]);
